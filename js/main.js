...
(function () {
  ...
  function injectCookieBanner() {
    ...
    banner.innerHTML = '<p>🍪 Nous utilisons des cookies pour mesurer l\'audience de ce site et améliorer votre expérience. <a href="/confidentialite">En savoir plus</a></p><div class="cookie-banner-actions"><button class="btn-refuse" type="button">Refuser</button><button class="btn-accept" type="button">Tout accepter</button></div>';
  ...
  document.querySelectorAll('a[href^="tel:"]').forEach(function (link) {
    link.addEventListener('click', function () {
      gtagIfConsent('event', 'phone_click', { phone_number: link.getAttribute('href').replace('tel:', '') });
    });
  });
